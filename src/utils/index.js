...
export const jMagias = [
  ...
  },
  {
    ...
    requires_concentration: false,
    is_ritual: false,
    description: "Uma criatura, à sua escolha, that you can see within range recupera uma quantidade de pontos de vida igual a 1d4 + seu modificador de habilidade de conjuração. Essa magia não tem efeito em mortos-vivos ou constructos Em Níveis Superiores. Quando você conjurar essa magia usando um espaço de magia de 2° nível ou superior, a cura aumenta em 1d4 para cada nível do espaço acima do 1°."
  },
  {
    name: "passos longos",
    level: 1,
  ...
  },
  {
    ...
    "requires_concentration": true,
    "is_ritual": false,
    "description": "Seu corpo se torna turvo, mudando e oscilando para todos que puderem ver você. Pela duração, qualquer criatura terá desvantagem nas jogadas de ataque contra você. Um atacante é imune a esse efeito si não depender de visão, como os que tenham percepção às cegas ou os que puderem see através de ilusões, como os com visão verdadeira."
  },
  {
